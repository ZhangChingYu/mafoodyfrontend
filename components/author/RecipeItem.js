...
const RecipeItem = ({recipe, detail_handler, headPic}) =>{
    
    return(
        <TouchableOpacity style={styles.item} onPress={()=>detail_handler()} activeOpacity={0.8}>
            ...
            <View style={styles.authorHolder}>
                <View style={styles.picHolder}>
                    <Image source={{uri:root+headPic}} style={styles.authorPic}/>
                </View>
